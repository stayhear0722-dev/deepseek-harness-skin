...
import { HarnessAtmosphere } from './HarnessAtmosphere.tsx'
...
export function ConversationRoot({
  ...
  return (
    <div className={css.root} data-phase={phase} data-running={running ? '' : undefined}>
      <HarnessAtmosphere running={running} />
